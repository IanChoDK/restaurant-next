...
export default function page() {
    ...
    return (
        <div className="flex flex-1 flex-col items-center justify-center bg-zinc-900">
            <main className="flex flex-1 w-full max-w-3xl flex-col items-center py-32 px-16 bg-zinc-900">
                ...
                <div className="flex flex-rowflex-wrap gap-4 justify-center mt-4">
                    <section className='w-full text-center items-center gap-4 h-full my-8 p-6 rounded-3xl flex flex-col bg-red-600'>
                        <div>
